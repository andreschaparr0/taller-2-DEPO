...
public class SandboxListas
{
    ...
    {
    	List<String> copia = new ArrayList<>(listaEnteros.size());
    ...
    public int[] getEnterosComoArreglo( )
    {
    	...
    	for(int entero : listaEnteros) {
    		arregloEnteros[contador] = entero;
    		contador++;
    	}
    ...
    {
    	List<String> nuevaLista = new ArrayList<>(objetos.size());
    ...
    public int contarApariciones( String cadena )
    {
    	...
    	for(String elemento : listaCadenas) { 
    		...
    		if(elemento.contains(cadenaMinusculas)) {
    			apariciones++;
    		}
    	}
        return apariciones;
    ...
    public int contarEnterosRepetidos( )
    {
    	...
    	for(int entero : listaEnteros) {
    		frecuencia.put(entero, frecuencia.getOrDefault(frecuencia.get(entero), 0)+1);
    	}
    	int repetidos = 0;
    	
    	for(int frecuenciaEntero : frecuencia.values()) {
    		if(frecuenciaEntero > 1) {
    			repetidos++;
    		}
    	}
