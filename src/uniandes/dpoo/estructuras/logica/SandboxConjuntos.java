...
public class SandboxConjuntos
{
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
    	...
    	arbolCadenas.removeIf(c -> c.toLowerCase().equals(cadenaMinuscula));
    }
    ...
    public void volverMayusculas( )
    {
        ...
        for (String cadena : arbolCadenas) {
            ...
            nuevoConjunto.add(cadenaMayusculas); 
        }
    ...
    {
    	TreeSet<String> arbolInvertido = (TreeSet<String>) arbolCadenas.descendingSet();
